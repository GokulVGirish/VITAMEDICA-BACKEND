...
class AdminInteractor implements IAdminInteractor {
  ...
  async getCurrentDayReport(): Promise<{ success: boolean; message: string; count?: { appointmentsCount: number; cancellationsCount: number; }; revenue?: number,unverifiedDocs:number,doctors:number,users:number}> {
      try{
       ...
       return {success:true,message:"success",revenue,count:appointCount,unverifiedDocs:unverifiedDoctors,doctors,users}
  ...
  async getWeeklyReport(): Promise<{ success: boolean; message: string; count?: { appointmentsCount: number; cancellationsCount: number; }; revenue?: { label: string; totalRevenue: number; }[] }> {
    
    try{
      const revenue=await this.repository.getWeeklyRevenue()
      const appointCount=await this.repository.getWeeklyAppointmentCount()
      return {success:true,message:"success",revenue:revenue,count:appointCount}
  ...
  async getMonthlyReport(): Promise<{ success: boolean; message: string; count?: { appointmentsCount: number; cancellationsCount: number; }; revenue?: { label: string; totalRevenue: number; }[]; }> {
      try{
  ...
  async getYearlyReport(): Promise<{ success: boolean; message: string; revenue?: { label: string; totalRevenue: number; }[]; }> {
      try{
