...
appointmentRouter.get("/", authentication_1.default, (0, role_Authenticate_1.default)("admin"), controller.fetchAppointmentList.bind(controller));
appointmentRouter.get("/:id", authentication_1.default, (0, role_Authenticate_1.default)("admin"), controller.fetchAppointmentDetail.bind(controller));
