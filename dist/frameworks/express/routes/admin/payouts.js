...
payoutRouter.get(`/refunds`, jwt_verify_1.default, (0, role_Authenticate_1.default)("admin"), controller.getRefundsList.bind(controller));
payoutRouter.get(`/refunds/:id`, jwt_verify_1.default, (0, role_Authenticate_1.default)("admin"), controller.getRefundDetail.bind(controller));
payoutRouter.get("/withdrawals", jwt_verify_1.default, (0, role_Authenticate_1.default)("admin"), controller.getWithdrawalList.bind(controller));
