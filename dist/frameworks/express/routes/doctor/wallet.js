...
walletRouter.get("/", authentication_1.default, (0, role_Authenticate_1.default)("doctor"), doctor_1.getDoctor, controller.getWalletDetails.bind(controller));
walletRouter.post("/withdraw/:amount", authentication_1.default, (0, role_Authenticate_1.default)("doctor"), doctor_1.getDoctor, controller.withdrawFromWallet.bind(controller));
